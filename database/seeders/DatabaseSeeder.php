...
class DatabaseSeeder extends Seeder
{
    public function run(): void
    {
        ...
        // Create attractions only if table is empty
        if (Attraction::count() === 0) {
            $attractions = [
                [
                    'category_id' => 1,
                    'name' => 'Colombo National Museum',
                    'description' => 'The largest museum in Sri Lanka, housing a vast collection of artifacts.',
                    'distance' => 18.5,
                ...
                [
                    ...
                    'description' => 'A wetland bird sanctuary home to over 100 species of birds.',
                    'distance' => 22.0,
                    'image' => 'attidiya.jpg',
                    'location' => 'Dehiwala',
                    'latitude' => 6.8428,
                ...
                [
                    'category_id' => 4,
                    'name' => 'Bolgoda Lake',
                    'description' => 'The largest natural lake in western Sri Lanka.',
                    'distance' => 24.5,
                ...
                [
                    ...
                    'description' => 'A famous Buddhist temple complex in Colombo.',
                    'distance' => 19.0,
                ...
                [
                    ...
                    'description' => 'A beautiful urban wetland teeming with wildlife.',
                    'distance' => 12.0,
                    'image' => 'talangama.jpg',
                    'location' => 'Talangama',
                    'latitude' => 6.9100,
                ...
                [
                    ...
                    'description' => 'One of the oldest buildings in Colombo built by the Dutch.',
                    'distance' => 20.0,
                ...
                [
                    ...
                    'description' => 'The largest and oldest park in Colombo.',
                    'distance' => 18.0,
                ...
                [
                    ...
                    'description' => 'A vibrant Hindu temple dedicated to Lord Murugan.',
                    'distance' => 15.0,
                    'image' => 'kovil.jpg',
                ...
                [
                    ...
                    'description' => 'A cultural heritage site near the Kelani River.',
                    'distance' => 2.0,
